      ...
      <main>
        ...
        <section id="beginner-commander-criteria" className="container">
          ...
          <p>
            ...
            something that both appeals to you, and that pushes you into the pit
            of success. Here are some criteria for what we consider a good
            starting point.
          </p>
          ...
          <ul>
            <li>
              <p>
                <strong>Costs less than 4 mana -</strong> Lower-cost commanders
                can be cast earlier and more frequently, allowing you to utilize
                their abilities more often throughout the game.
              </p>
              <p>
            ...
            <li>
              <p>
                ...
                just one color to worry about is easier, but in most cases, it's
                actually the opposite. Having your commander identity be a mix
                of colors gives you more options and flexibility in your
                deck-building. This means that you can include more cards that
                you like and that work well together.
              </p>
              <p>
                I would recommend staying with 2 color commanders for your first
                deck. This gives you a good balance of options and simplicity. 3
                color commanders can be a bit more complex and require more
                attention to mana fixing. I still think they can be ok though
                and I've included a few in the list below.
              </p>
            </li>
            <li>
              <p>
                <strong>Draws you cards -</strong> Card draw keeps your hand
                full of options and helps maintain momentum. Commanders that can
                draw you cards are great for beginners because they help you
                recover from setbacks and stay in the game.
              </p>
              <p>
                This is not a hard and fast rule, but it's a good guideline to
                follow. Card draw is one of the most powerful effects in Magic:
                The Gathering, so having a commander that can do it is a huge
                advantage.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                building. This makes it easier to know what cards to include and
                what to leave out.
              </p>
              <p>
                For example:{" "}
                ...
                , while a powerful commander, doesn't give you much guidance on
            ...
            <li>
              ...
              <p>
                In my recommendations, I've included both commanders that do and
                don't have a clear way to win. Those that do have a clear way to
                win have earned themselves a higher placement though.
              </p>
            </li>
          </ul>
        </section>
        ...
        <section id="top-commanders" className="container">
          ...
          <p>
            These commanders are extremely straightforward and forgiving, making
            them perfect for your first deck.
          </p>
          <ul>
            <li>
              <p>
                ...
                - A Voltron-style commander who encourages you to equip him with
                Auras and Equipment and swing in for a win via commander damage!
                He draws you cards whenever he attacks, keeping your hand full
                and strategy simple: gear up and swing.
              </p>
            </li>
            <li>
              <p>
                ...
                opponents' life. Her abilities provide clear direction: amass an
                army and overwhelm your foes.
              </p>
            </li>
            <li>
              <p>
                ...
                - A merfolk tribal commander who rewards you for playing merfolk
                and attacking. He offers multiple abilities that enhance your
          ...
          <h4>Recommended</h4>
          <p>
            These are still fun, simple and forgiving commanders, but they might
            require a bit more thought to play effectively, or they might have a
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                As a suggestion, there are equipment cards that come in already
                attached to a creature. They're a great pick for Akiri! Here are
                a few examples:{" "}
            ...
            <li>
              <p>
                ...
                - A commander that offers protection for himself with his shield
                counter. He encounrages you to flood the board with 1/1
            ...
            <li>
              <p>
                ...
                - Encourages you to play and buff creatures, then attack. Offers
                an aggressive strategy with room for growth.
              </p>
            </li>
          </ul>
        </section>
        ...
        <section id="deckbuilding-guide" className="container">
          ...
          <p>
            You've now selected a commander and are ready to build your deck. In
            order to set you up for success, I've put together a simple
            guide/framework for you to work within so that you can make lots of
            fun and impactful decisions about how to build your deck, while not
            getting overwhelmed.
          </p>
          ...
          <p>
            ...
            make decisions that impact the game and that allows you to play the
            game the way you want to play it. To that end, a good deck ought to
            fullfill the following quotas:
          </p>

          <ul>
            <li>
              <p>
                <strong>Land (40)</strong> - I recommend 40 lands as an absolute
                baseline for a commander deck if you're a beginner. This is
                because lands are the most important cards in your deck. They're
                what allow you to play the game and make meaningful decisions.
                If you had a choice between having too many lands or too few,
                you'd always want to have too many.
              </p>
              <p>
            ...
            <li>
              <p>
                <strong>Ramp (9)</strong> - Cards that help you get more mana so
                you can play more spells, more often.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                with one of Magic's most common strategies: using the graveyard
                as a resource. If you don't have any of these, you might find
                yourself losing to a deck that uses the graveyard with little to
                no ways to interact with it. We're maximising our opportunities
                to make choices so that you can have more fun!
              </p>
            </li>
            <li>
              <p>
                <strong>Land destruction (2)</strong> - This is a contraversial
                category, but I think it's important to have at least a few ways
                of dealing with lands. This is because there are many lands that
                can be very powerful and can win the game on their own. Having
                some ways to deal with them can be very important for your
                ability to have fun.
              </p>
              <p>
          ...
          <p>
            You'll notice that the numbers above add up to 74 cards. This leaves
            you with 25 cards to build your "core" deck with. These are the
            cards that you'll use to build your deck's identity and strategy.
            They should be cards that you enjoy playing and that work well with
            your commander.
          </p>
          <p>
            I would recommend starting here. Your commander + 25 cards that work
            well with your commander. This will give you a solid foundation to
            build off of and inform the rest of your deck-building decisions.
          </p>
          <p>
            ...
            work well with him. You might also include some cards that help you
            protect him as he's so important to your strategy.
          </p>

          <h4>Filling out the rest</h4>
          <p>
            Now that you've chosen a set of core cards that you think are super
            cool and work well with your commander, you should now start filling
            up the cards in the above categories. I would stick to these
            <strong>very</strong> closely. They're, I believe, a great guideline
            for what you need in your deck to make sure you're having fun.
          </p>
        ...
        <section id="example" className="container">
          ...
          <p>
            ...
            fill in the rest. I'd recommend opening the finished decklist on my{" "}
          ...
          <p>
            ...
            that work well with Wyleth. I'll be looking for cards that fullfill
            this query{" "}
